...
const MarketplaceDesktop = () => {
  ...
  const fetchData = () => {
      fetch('https://opensea13.p.rapidapi.com/assets?order_direction=desc&limit=12&include_orders=false', options)
      .then(response => {
							...
							<div className="nft-info-div">
								<div className="artst-info-div">
									...
									<div className="artist-avatar-name">
										...
										<div className="nft-artist-div">{nft?.creator?.user?.username}</div>
									</div>
								</div>
